...
class Search extends Component {
    ...
    render() {
        let { inpValue, isShow, classShow, classify, sortRank, ind, num ,tabSortImg,tabPrice,historyShow} = this.state
        return (
                        ...
                        {isShow ? <div className="searchGoods">
                            <div className="searchConditionWrap">
                                ...
                                {classShow ? <div className="searchConditionCategoryWrap onePx_top">
                                    {classify.map((item, index) => <button className={`categoryListItem ${index === ind ? 'active' : ''}`} onClick={this.handTabClassify.bind(this, index)}>{item}</button>)}
                                </div> : null}

                            </div>
                            <div className="goodsList">
                                <Link className="goodsItem" to="/goods/">
                                    <div className="goodsItemImg">
                                        <img src="" />
                                    </div>
                                    <div className="goodsItemName"></div>
                                    <div className="goodsItemPrice"></div>
                                </Link>
                            </div>
                        </div> : null}
