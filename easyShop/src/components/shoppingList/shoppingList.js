...
class ShoppingList extends Component {
                ...
                <div className='isCheckItem'>
                    {
                        ...
                        onClick={() =>{this.props.shoppingCart.updata(item.product_id)}} /> :
                        ...
                        <div className='cartEditNum'>
                            ...
                            <div className='count'>
                                <div className='countOp'>
                                    <div className='jian' onClick={this.count.bind(this,item.number-1,item.product_id,item.id,item.goods_id)}>-</div>
    ...
    count(count,product_id,id,goods_id){
        ...
        this.props.shoppingCart.up_Count(obj)
    }
}
